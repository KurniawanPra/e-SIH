...
### Community 9 - "api.ts"
Cohesion: 0.13
Nodes (14): API_URL, BACKEND_DRIVER, BackendDriver, logoutSession(), PORTAL_LOGIN_URL, PORTAL_URL, prepareCsrf(), TARGET_APP_ID (+6 more)
...
Cohesion: 0.07
Nodes (36): activityBuffer, ActivityEntry, ActivitySubscriber, emitActivity(), filterArgs(), getActivityAfter(), getActivityHistory(), getSubscriberCount() (+28 more)
...
Cohesion: 0.38
Nodes (5): activeExchanges, CallbackContent(), exchangeSsoToken(), getApiError(), validateRuntimeConfig()
