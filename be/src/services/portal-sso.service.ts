...
export async function exchangePortalToken(
  ...
  const isAuthorizedUnit = !config.isProduction || /sistem|it|teknologi|informasi|hsse|hse|safety|k3|mr/i.test(unitNama) || /sistem|it|teknologi|informasi|hsse|hse|safety|k3|mr/i.test(unitPath)
  if (!isAuthorizedUnit) {
